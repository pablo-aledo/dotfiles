...
echo 'export PYTHONPATH=$HOME/dwx-zeromq-connector/dwx-zeromq-connector-master/v2.0.1/python/api/:$PYTHONPATH' >> ~/.paths

echo 'export PYTHONPATH=$HOME/dwx-zeromq-connector/dwx-zeromq-connector-master/v2.0.1/python/examples/template/modules/:$PYTHONPATH' >> ~/.paths
echo 'export PYTHONPATH=$HOME/dwx-zeromq-connector/dwx-zeromq-connector-master/v2.0.1/python/examples/template/strategies/:$PYTHONPATH' >> ~/.paths
echo 'export PYTHONPATH=$HOME/dwx-zeromq-connector/dwx-zeromq-connector-master/v2.0.1/python/examples/template/strategies/base/:$PYTHONPATH' >> ~/.paths
